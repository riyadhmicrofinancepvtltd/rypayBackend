...
export declare class UsersController {
    ...
    getTransactionHistory(req: any, page?: number, limit?: number, transactionMode?: string): Promise<{
        success: boolean;
        message: string;
    ...
    bankValidate(req: any, bankRequest: bankValidateRequestDto): Promise<{
        success: boolean;
        message: string;
        data?: undefined;
    } | {
    ...
    checkPaymentStatus(req: any, statusRequest: PaymentStatusRequestDto): Promise<{
        success: boolean;
        message: string;
        data: any;
    } | {
